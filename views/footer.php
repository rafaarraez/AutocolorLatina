        ...
        <div class="col-12 row section-padding-us" style="margin: 0px; padding: 0px;">
            <div class="col-md-5 col-lg-5 col-xs-12" style="margin: 0px; padding: 0px;">
                <div class="img-worker">
                    <img src="http://autocolorlatina.com/src/img/worker.jpg" alt="">
                </div>
            </div>
            <div class="col-md-7 col-lg-7 col-xs-12 derecha" style="padding: 0px;">
                ...
                <div id="footer" style="padding: 10px;">
                    <form class="gform pure-form pure-form-stacked" method="POST" action="https://script.google.com/macros/s/AKfycbwxcuE8aaMZr22DN5xdgCHEHw7ahxwSXLnoBPgLXh7TlS51m1tE/exec">
                        <div class="col-md-12 form-line">
                            <div class="form-group">
                                <label for="email">Recibe actualizaciones en tu bandeja de entrada</label>
                                <input class="form-control-franja" id="subscribe_email" type="text" name="Correo" placeholder='Email address' />
                                <input type="submit" class="btn btn-common btn-form-franja" id="form-submit" value="Enviar" />
                            </div>
                        </div>
                ...
                <div class="col-12 row contact">
                    <div class="col-md-4 col-lg-4 col-xs-12" style="margin: 0px; padding: 0px;">
                        <img src="http://autocolorlatina.com/src/img/audifonos.png" alt="">
                    </div>
                    <div class="col-md-8 col-lg-8 col-xs-12 numbers" style="margin: 0px; padding: 0px;">
                        <div class="num">
                            <p class="h1">CONTÁCTENOS AL</p>
                            <p class="h4">0241-867-9313</p>
                            <p class="h4">0414-424-3700</p>
                        </div>
